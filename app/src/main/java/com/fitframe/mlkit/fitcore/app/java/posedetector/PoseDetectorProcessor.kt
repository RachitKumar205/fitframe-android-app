...
import com.fitframe.mlkit.fitcore.app.java.VisionProcessorBase
...
class PoseDetectorProcessor(
    context: Context, options: PoseDetectorOptionsBase?, private val showInFrameLikelihood: Boolean
    ...
    override fun onSuccess(pose: Pose, graphicOverlay: GraphicOverlay) {
